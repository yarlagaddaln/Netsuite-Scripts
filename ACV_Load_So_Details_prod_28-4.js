  ...
  if(type=='create'){
        ...
        for (k = 1; k <= deal_no_of_years; k++) {
            ...
            if (deal_no_of_years == 1) {
				...
				nlapiLogExecution('DEBUG', 'End date',validate_customdate.getFullYear());
				nlapiLogExecution('DEBUG', 'End date',validate_actualend.getFullYear());
				if((validate_customdate.getFullYear()> validate_actualend.getFullYear())){
					...
					if((validate_customdate.getMonth()>validate_actualend.getMonth())){
