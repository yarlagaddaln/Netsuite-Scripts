        ...
        try {
            ...
            for (i = 1; i <= parseInt(no_of_years); i++) {
                ...
                for (j = 1; j <= parseInt(no_of_reps); j++) {
                    ...
                    acv_per_rep =  parseFloat(ACVModel.getFieldValue('custrecord_macv_allocation_id' + j));

                    acv_per_year_rep = Math.abs(parseFloat(total_acv) * parseInt(acv_per_rep) / 100);
                    ...
                    if (i == 1) {
                        ...
                        rep_last_acv = parseFloat(ACVModel.getFieldValue('custrecord_macv_total_acv_id'+parseInt(i-1)));
                        acv_per_year_rep_renewal = Math.abs(rep_last_acv) * parseInt(acv_per_rep) / 100;
                        acv_rec.setFieldValue('custrecord_acv_renewal', acv_per_year_rep_renewal);
                        nlapiLogExecution('DEBUG','Renewal','Value:'+ rep_last_acv);
                        ...
                        if (parseInt(ACVModel.getFieldValue('custrecord_macv_upsell_id'+i)) > parseInt(0)) {
                            ...
                            rep_current_acv = parseFloat(ACVModel.getFieldValue('custrecord_macv_upsell_id'+i));
							nlapiLogExecution('DEBUG',' issue Upsell','Value:'+rep_current_acv);
                            acv_per_year_rep_upsell =Math.abs(rep_current_acv) * parseInt(acv_per_rep) / 100;
                            nlapiLogExecution('DEBUG','Upsell','Value:'+ acv_per_year_rep_upsell);
                            acv_rec.setFieldValue('custrecord_acv_upsell',  acv_per_year_rep_upsell);
                        }
                        ...
                        if (parseInt(ACVModel.getFieldValue('custrecord_macv_cont_upsell_id'+i)) > parseInt(0)) {
                            rep_current_acv =parseFloat(ACVModel.getFieldValue('custrecord_macv_cont_upsell_id'+i));
                            acv_per_year_rep_contract_upsell = Math.abs(rep_current_acv) * parseInt(acv_per_rep) / 100;
                            acv_rec.setFieldValue('custrecord_acv_cont_upsell',  acv_per_year_rep_contract_upsell);
                            nlapiLogExecution('DEBUG','Contract Upsell','Value:'+ acv_per_year_rep_contract_upsell);
                        }
                        ...
                        if (parseInt(ACVModel.getFieldValue('custrecord_macv_cancel_id'+i)) > parseInt(0)) {
                            rep_current_acv = parseFloat(ACVModel.getFieldValue('custrecord_macv_cancel_id'+i));
                            acv_per_year_rep_cancellation = Math.abs(rep_current_acv) * parseInt(acv_per_rep) / 100;
                            acv_rec.setFieldValue('custrecord_acv_cancellation', parseInt( acv_per_year_rep_cancellation));
                            nlapiLogExecution('DEBUG','Cancellation','Value:'+ acv_per_year_rep_cancellation);
                        }
                        ...
                        if (parseInt(ACVModel.getFieldValue('custrecord_macv_shrinkage_id'+i)) > parseInt(0)) {
                            rep_current_acv = parseFloat(ACVModel.getFieldValue('custrecord_macv_shrinkage_id'+i));
                            acv_per_year_rep_shrinkage =Math.abs(rep_current_acv) * parseInt(acv_per_rep) / 100;
                            acv_rec.setFieldValue('custrecord_acv_shrinkage', parseInt( acv_per_year_rep_shrinkage));
                            nlapiLogExecution('DEBUG','Shrinkage','Value:'+ acv_per_year_rep_shrinkage);
                        }

                        acv_per_year_rep_breakdown = parseFloat(ACVModel.getFieldValue('custrecord_macv_new_id'+i)) + parseFloat(acv_per_year_rep_renewal) + parseFloat(acv_per_year_rep_upsell) + parseFloat(acv_per_year_rep_contract_upsell) - parseFloat(acv_per_year_rep_cancellation) - parseFloat(acv_per_year_rep_shrinkage);
                        acv_rec.setFieldValue('custrecord_acv_total_acv', parseFloat( acv_per_year_rep_breakdown));
                        nlapiLogExecution('DEBUG','Total ACV','Value:'+parseFloat(acv_per_year_rep_breakdown));
