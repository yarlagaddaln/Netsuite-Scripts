...
function VALIDATE_LINE_ESTIMATE_INIT(type) {
	...
	if (type == 'item') {
		...
		if (getitem_id == 1042 && item_change_status == true ) {
			...
			//alert('2nd');
			//alert('change status'+item_change_status);
			...
			if ((bundle_ids.length > 0) && (current_line != '') && (current_line != 'undefined') && (item_change_status == true) && (field_name!='price') && (field_name!='amount') && (field_name!='taxrate1') && (field_name!='excludefromraterequest')&& (field_name!='quantity')) {
